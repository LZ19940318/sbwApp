...
//        }
        ...
        jsString = [jsString stringByReplacingOccurrencesOfString:@"{mail}" withString:userMsg[@"InternetAddress"]];
        //js加载base64字符串的格式
        NSString *prefixStr  = @"data:image/jpg;base64,";
        NSString *jsImageStr;
        NSString *jsImageStr1;
        
        jsImageStr1 = [[NSString alloc]initWithFormat:@"%@%@",prefixStr,[[DataManager sharedDataManager] userPhoto] ];
        jsImageStr1 = [jsImageStr1 stringByReplacingOccurrencesOfString:@"\r\n" withString:@""];
        jsString = [jsString stringByReplacingOccurrencesOfString:@"{UserimgStr}" withString:jsImageStr1];
        /** 用户头像 */
//        NSString  *userPhoto = [[DataManager sharedDataManager] userPhoto];
        //
        
//        if (userPhoto != nil || [userPhoto isEqualToString: @""]) {
//            NSString *photo = userPhoto;
//            jsImageStr1 = [[NSString alloc] initWithFormat:@"%@%@",prefixStr, userPhoto];
            //传递图片的字符串
//            jsString = [jsString stringByReplacingOccurrencesOfString:@"{UserimgStr}" withString:jsImageStr1];
//        }
