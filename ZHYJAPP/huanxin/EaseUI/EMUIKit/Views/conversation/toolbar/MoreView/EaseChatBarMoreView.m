...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    UILabel *photoLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets,CGRectGetMaxY(_photoButton.frame), CHAT_BUTTON_SIZE , 20)];
    photoLabel.text = @"照片";
    ...
    UILabel *takePicLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE,CGRectGetMaxY(_takePicButton.frame), CHAT_BUTTON_SIZE , 20)];
    ...
    UILabel *locationLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2,CGRectGetMaxY(_locationButton.frame), CHAT_BUTTON_SIZE , 20)];
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        UILabel *audioCallLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3 - 5,CGRectGetMaxY(_audioCallButton.frame), CHAT_BUTTON_SIZE + 10 , 20)];
        audioCallLabel.text = @"语音电话";
        audioCallLabel.textAlignment = NSTextAlignmentCenter;
        audioCallLabel.font = [UIFont systemFontOfSize:13];
        audioCallLabel.textColor = [UIColor grayColor];
        ...
        [_videoCallButton setFrame:CGRectMake(insets, 12 * 2 + CHAT_BUTTON_SIZE + 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
        ...
        UILabel *videoCallLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets - 5,CGRectGetMaxY(_videoCallButton.frame), CHAT_BUTTON_SIZE + 10, 20)];
        videoCallLabel.text = @"视频电话";
        videoCallLabel.textAlignment = NSTextAlignmentCenter;
        videoCallLabel.font = [UIFont systemFontOfSize:13];
        videoCallLabel.textColor = [UIColor grayColor];
