...
//    [_statusButton setImage:[UIImage imageNamed:@"rl_01.png"] forState:UIControlStateNormal];
...
//                [self addLinks:model.text toLabel:_bubbleView.textLabel];
                if (model.message.ext != NULL) {
                    _bubbleView.frame = CGRectMake(0, 0, 192, 66);
                    UIView *labelView = [UIView new];
                    labelView.frame = CGRectMake(0, 0, _bubbleView.frame.size.width, _bubbleView.frame.size.height);
                    labelView.backgroundColor = [UIColor redColor];
                    labelView.backgroundColor = [UIColor colorWithRed:235/255.0f green:236/255.0f blue:239/255.0f alpha:1];
                    UILabel *lati1= [[UILabel alloc] initWithFrame:CGRectMake(0, 0, labelView.frame.size.width, _bubbleView.frame.size.height/3)];
                    lati1.textColor = [UIColor whiteColor];
                    lati1.backgroundColor = [UIColor colorWithRed:72/255.0f green:97/255.0f blue:142/255.0f alpha:1];
//                    lati1.text = @"待办提醒";
                    lati1.textAlignment = NSTextAlignmentLeft;
                    lati1.font = [UIFont systemFontOfSize:10];
                    [labelView addSubview:lati1];
//                    [_bubbleView addSubview:labelView];
                    
                    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(0, _bubbleView.frame.size.height/3, labelView.frame.size.width, _bubbleView.frame.size.height/3*2)];
                    label2.text = model.text;
                    label2.numberOfLines = 2;
                    label2.font = [UIFont systemFontOfSize:10];
//                    [labelView addSubview:label2];
                    NSString *str = model.text;
                    _bubbleView.textLabel.attributedText = [[EaseEmotionEscape sharedInstance] attStringFromTextForChatting:str textFont:self.messageTextFont];
...
//    _rightBubbleMargin = UIEdgeInsetsMake(0, 0, 0, 0);
}
...
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"tapRecognizer" object:tapRecognizer];
...
//      bubbleMaxWidth = (cell.leftBubbleMargin.left + cell.leftBubbleMargin.right + cell.rightBubbleMargin.left + cell.rightBubbleMargin.right)/2;
    CGFloat height = EaseMessageCellPadding + cell.bubbleMargin.top + cell.bubbleMargin.bottom +EaseMessageCellPadding;
