...
- (UIView *)switchView
{
    if (_switchView == nil) {
        ...
        UISwitch *switchControl = [[UISwitch alloc] initWithFrame:CGRectMake(100, oY, 0, _switchView.frame.size.height-20)];
        switchControl.transform = CGAffineTransformMakeScale(0.65, 0.65);
        ...
        _groupMemberSwitch.transform = CGAffineTransformMakeScale(0.65, 0.65);
        ...
        _groupMemberLabel.font = [UIFont systemFontOfSize:14.0];
...
//    }
    for (NSDictionary *username in selectedSources) {
        [source addObject:username[@"ImUserName"]];
    }
